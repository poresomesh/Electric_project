...
export const LiveBilling: React.FC<LiveBillingProps> = ({ initialBlockId }) => {
  ...
  }, [isAdmin, inchargeBlockId, selectedBlockId]);
  ...
  const [voucherNo, setVoucherNo] = useState<string>(() => {
    ...
    const blkCode = (inchargeBlockId || initialBlockId || 'BLK1').slice(0, 4).toUpperCase();
    return `INV-${y}-${m}-${blkCode}`;
  });
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 print:block">
        ...
        {/* Right Column: Printable Invoice */}
